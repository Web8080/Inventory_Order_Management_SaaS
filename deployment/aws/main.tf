...
terraform {
  ...
  backend "s3" {
    bucket = "inventory-saas-terraform-state"
...
resource "aws_elasticache_replication_group" "main" {
  ...
  description                = "Redis cluster for inventory SaaS"
...
resource "aws_s3_bucket" "static" {
  bucket = "${var.environment}-inventory-saas-static"
...
resource "aws_ecr_repository" "backend" {
  name                 = "${var.environment}-inventory-saas-backend"
...
resource "aws_ecr_repository" "frontend" {
  name                 = "${var.environment}-inventory-saas-frontend"
  image_tag_mutability = "MUTABLE"
...
resource "aws_ecr_repository" "ml" {
  name                 = "${var.environment}-inventory-saas-ml"
  image_tag_mutability = "MUTABLE"
...
resource "aws_ecs_cluster" "main" {
  name = "${var.environment}-inventory-saas"
...
resource "aws_ssm_parameter" "db_password" {
  name  = "/${var.environment}/inventory-saas/db-password"
  type  = "SecureString"
  value = var.db_password
}

resource "aws_ssm_parameter" "secret_key" {
  name  = "/${var.environment}/inventory-saas/secret-key"
  type  = "SecureString"
